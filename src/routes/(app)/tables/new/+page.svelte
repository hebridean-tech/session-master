...
<div class="max-w-lg mx-auto">
  ...
  <form method="POST" action="?/create" class="space-y-5">
    ...
    <div class="flex gap-4 pt-2">
      <a href="/tables" class="px-5 py-2.5 bg-stone-700 hover:bg-stone-600 text-stone-200 rounded-md transition-colors font-medium">
        Cancel
      </a>
      <button type="submit"
        class="px-5 py-2.5 bg-amber-600 hover:bg-amber-500 text-stone-950 font-semibold rounded-md transition-colors">
        Create Table
      </button>
    </div>
  </form>
